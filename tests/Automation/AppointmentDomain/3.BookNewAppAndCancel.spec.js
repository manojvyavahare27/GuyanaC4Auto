...
test.describe("Database Comparison Book New App and Cancel", () => {
    ...
    //  await homepage.clickOnAppointmentIcon()    
     ...
     await page.getByTestId('appointmentsDrawerHeader').click()
    ...
    await patientsearch.uncheckIncludeServicePatientIfChecked()
     ...
     await addreferral.clickOnBackButton()     
          ...
          await page.pause()
         await page.getByTestId('availableSlots').click()
          await page.waitForTimeout(2000)
 ...
 await page.getByRole('checkbox', { name: 'hideLabel' }).check();
  await page.locator('#menu-healthProfessionalList > .MuiBackdrop-root').click();
  ...
  await page.waitForTimeout(2000)
          ...
          await page.pause()
          await page.getByTestId('Save and Book Appointment').click()
