class PatientDeath
{
    constructor(page)
    {
       ...
       this.txt_causeOfDeath=page.locator("xpath=//input[@id='searchImmediateCauseOfDeath']")
        ...
        this.txtbox_CauseOfDeathWithCode=page.locator("xpath=//input[@id='searchImmediateDeathCode']")
