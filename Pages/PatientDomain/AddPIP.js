class AddPIP
{
    constructor(page)
    {
        ...
        this.txtbox_PIPEnternalProf=page.locator("xpath=//input[@name='externalProfessional']")
        ...
        this.chkbox_SendPatientTextEmail=page.getByRole('checkbox', { name: 'Send patient related Email/' })
        ...
        this.chkbox_HelpingPatients=page.getByRole('checkbox', { name: 'Helping patients and their' })
        this.chkbox_BeingPhotographed=page.getByRole('checkbox', { name: 'Being photographed or videoed' })
        this.chkbox_GeneralPublicity=page.getByRole('checkbox', { name: 'For use on the Automation Est' })
    ...
    {
        await this.txtbox_PIPMobile.fill('9876543210')
    }
