...
//Stock item expands parameters
this.subCategrory=page.locator("xpath=//h1[normalize-space()='Sub Category:']/following-sibling::h1")
this.cellmaBarcode=page.locator("xpath=//h1[normalize-space()='Cellma Barcode:']/following-sibling::h1")
this.itemBarcodes=page.locator("xpath=//h1[normalize-space()='Item Barcode:']/following-sibling::h1")
this.itemShortBarcodes=page.locator("xpath=//h1[normalize-space()='Item Short Barcode:']/following-sibling::h1")
...
async enterManufacturer() {
    await this.manufacturerInput.click()
    await this.page.getByRole('option', { name: 'Cipla Manufacturers' }).click()
  //  await this.manufacturerInput.type('Cipla Manufacturers');
...
async FillPositions1()
{
    ...
    await this.page.getByRole('option', { name: 'Position 1' }).click() 
}

async FillPositions2()
{
    await this.position2.click()    
    await this.page.getByRole('option', { name: 'Position 2' }).click()
}
async FillPositions3()
{
    await this.position3.click()    
    await this.page.getByRole('option', { name: 'Position 3' }).click()
}
async FillPositions4()
{
    await this.position4.click()    
    await this.page.getByRole('option', { name: 'Position 4' }).click()
}
