class Homepage{
    constructor(page)
    {
        ...
        this.sidebarPatientIcon=page.locator("xpath=//div[@data-testid='moduleDrawerPatients']")
        this.iconHomePage=page.locator("xpath=//div[@data-testid='moduleDrawerHomeDashboard']")
        this.iconAppointment=page.locator("xpath=//div[@data-testid='moduleDrawerAppointments']")
        ...
        this.AddMedicationlink=page.getByRole('button', { name: 'Add', exact: true })
