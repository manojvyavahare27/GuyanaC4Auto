...
await page.pause()
 ...
 await page.pause()
        const locators = [
            patientdeath.txt_causeOfDeath, 
            patientdeath.txtbox_CauseOfDeathWithCode,
            patientdeath.txtbox_CauseofDeathType,
            // patientdeath.checkbox_Deathtype,
            // patientdeath.txtbox_OtherCauseOfDeath,
            // patientdeath.checkboxForSearchAntecedentcauseofDeath,
            patientdeath.txtbox_Additionalnotes,
            patientdeath.calendar_DateofDeath,
            patientdeath.dropdown_MarkPatientAsDead,
          //  patientdeath.checkbox_SearchAntecedentcauseofDeath,           
            // patientdeath.btn_SaveDeadPatient,
            // patientdeath.btn_ViewOnlyInReadOnly
        ];

        fileName = "LocatorJSON/PatientDomain/PatientDeathPage.json";
