class AddReferral{
    constructor(page)
    {
        ...
        this.dropdownsourceofreferral=page.locator("xpath=//div[@data-testid='sourceOfReferral']")
        this.dropdownreferraltype=page.locator("xpath=//div[@data-testid='referralType']")
        this.dropdownreferralreason=page.locator("xpath=//div[@data-testid='referralReason']")
        ...
        this.txtboxreferringprofessional=page.locator("xpath=//div[@data-testid='referringProfessional']")
        this.dropdownservice=page.locator("xpath=//div[@data-testid='service']")
        this.dropdownclinictype=page.locator("xpath=//input[@name='clinicType']")
        this.dropdowncliniclocation=page.locator("xpath=//input[@name='clinicLocation']")

        this.dropdownteam=page.locator("xpath=//input[@name='team']")
        this.dropdownpatientcare=page.locator("xpath=//div[@data-testid='patientCare']")
        this.dropdownpreferrersexforassessment=page.locator("xpath=//input[@name='preferredSexForAssessment']")
