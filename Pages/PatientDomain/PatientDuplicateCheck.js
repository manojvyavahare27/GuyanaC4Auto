...
class PatientDuplicateCheck
{
    constructor(page)
    {
        ...
        this.dropdown_Title=page.locator("xpath=//input[@name='title']")
        ...
        this.txtbox_mobile=page.locator("xpath=//input[@name='mobile']")
        this.txtbox_EmailID=page.locator("xpath=//input[@name='email']")
...
// Create an array of locators
    ...
    async selectUniqueIdentification()
    {
        ...
        await this.page.getByRole('option', { name: 'Birth Certificate PIN' }).click()        
    }

    async enterUniqueIdentificationId(pid_value1)
    {
        await this.txtbox_unique_Identification_Id.fill(pid_value1)
    }

    async selectPhotoIdentification()
    {
        await this.dropdown_photo_Identification.click()
        await this.page.getByRole('option', { name: 'National Identification Number' }).click()
    }
