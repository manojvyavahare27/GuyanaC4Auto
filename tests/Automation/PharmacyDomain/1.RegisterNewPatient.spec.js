...
let locatorsSearch = [
    ...
    let fileName = "LocatorJSON/PatientDomain/PharmacyPatientSearchPage.json";
    await checkAllLocatorVisibility(locatorsSearch, expect);
    ...
    let locatorsDuplicate = [
     ...
     fileName = "LocatorJSON/PatientDomain/PharmacyPatientDuplicatePage.json";
    await checkAllLocatorVisibility(locatorsDuplicate, expect);
     ...
     fileName = "LocatorJSON/PatientDomain/PharmacyPatientAddressPage.json";
    await checkAllLocatorVisibility(locatorsAddress, expect);
       ...
       // await page.pause()
        ...
        fileName = "LocatorJSON/PatientDomain/PharmacyPatientGPPage.json";
