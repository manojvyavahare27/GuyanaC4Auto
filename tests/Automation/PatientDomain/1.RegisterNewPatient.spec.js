...
let locatorsSearch = [
    ...
    let locatorsDuplicate = [
      // patientduplicatecheck.txtbox_Identifier,
      // patientduplicatecheck.dropdown_UniqueIdentification,
      // patientduplicatecheck.txtbox_photo_Identification_Id,
      // patientduplicatecheck.dropdown_unique_Identification,
    ...
    fileName = "LocatorJSON/PatientDomain/DuplicateCheckPage.json";
    await checkAllLocatorVisibility(locatorsDuplicate, expect);
    ...
    //  fileName = "LocatorJSON/PatientDomain/DuplicateCheckPage.json.json";
    // await checkAllLocatorVisibility(locatorsDuplicate, expect);
...
logger.info("Next button clicked successfully");
      ...
      //Add Address page
       //check visibility for address locators

         let locatorsAddress = [           
      addaddress.txtbox_numberandroad,
      addaddress.txtbox_town,
      addaddress.txtbox_district,
      addaddress.txtbox_county,
      addaddress.txtbox_postcode,    
      addaddress.txtbox_permISOCountryCode,
      addaddress.dropdown_Country,
      addaddress.txtbox_permICAOCountryCode,
      addaddress.txtbox_permPhone,
      addaddress.txtbox_permEmail,
      addaddress.txtbox_PerMobileNumber,
      addaddress.txtbox_permWorkPhone,
      addaddress.txtbox_permFax,
      addaddress.dropdown_permHealthRegion,
      addaddress.dropdown_permLocationZone,
      addaddress.btn_PermAddressAddView,
      addaddress.txtbox_tempNumberandRoad,
       addaddress.txtbox_temptown,
        addaddress.txtbox_tempDistrict,
         addaddress.txtbox_tempCounty,
          addaddress.txtbox_PostCode,
           addaddress.dropdown_TempCountry,
            addaddress.txtbox_tempISOCountryCode,
             addaddress.txtbox_tempICAOCountryCode,
              addaddress.txtbox_tempPhone,
               addaddress.txtbox_tempEmail,
                addaddress.txtbox_TempMobileNumber,
                 addaddress.txtbox_tempWorkPhone,
                  addaddress.txtbox_tempFax,
      addaddress.dropdown_tempHealthRegion,
      addaddress.dropdown_tempLocationZone,
      addaddress.btn_tempAddressAddView,
      addaddress.calender_StartDate,
      addaddress.calender_EndDate,
      addaddress.btn_SaveForAddress
    ];

     fileName = "LocatorJSON/PatientDomain/PatientAddressPage.json";
    await checkAllLocatorVisibility(locatorsAddress, expect);
...
logger.info("Post code entered successfully");
      ...
      // Click the dropdown
await page.locator('#countryPermanentAddress').click();
...
logger.info("Save address button clicked successfully");
      ...
      await expect(page.getByText('Patient address added successfully')).toHaveText('Patient address added successfully')
       ...
       //Add PIP        
        let locatorsPIP = [
          addpip.dropdown_PIPTitle,
          addpip.txtbox_PIPFamilyName,
          addpip.txtbox_PIPGivenName,
          addpip.txtbox_PIPMiddleName,
          addpip.calender_PIPBornDate,
          addpip.dropdown_PIPEthnicity,
          addpip.dropdown_PIPOccupation,
          addpip.txtbox_PIPMobile,
          addpip.txtbox_PIPEmail,
          addpip.dropdown_PIPRelation,
          addpip.dropdownPIPNextOfkin,
        
          addpip.dropdownPIPFamilyAwareOfIllness,
          addpip.dropdownPIPIdentifierType,
          addpip.txtboxPIPIdentifier,
          addpip.txtbox_PIPEnternalProf,
          addpip.txtbox_PIPProfessionalTitle,
          addpip.dropdown_PIPReceivePatientLetter,
          addpip.dropdown_PIPReceiveAppointmentLtr,
          addpip.dropdown_PIPPrintPartnerdetailsOnReg,
          addpip.chkbox_SendPatientTextEmail,
          addpip.chkbox_PIPIsReferrer,
          addpip.txtbox_PIPNotes,
          addpip.chkbox_AssistingInPartner,
          addpip.chkbox_HelpingPatients,
          addpip.chkbox_BeingPhotographed,
          addpip.chkbox_GeneralPublicity,
          addpip.btnSavePIP
        ];

        fileName = "LocatorJSON/PatientDomain/PharmacyPatientPIPPage.json";
        await checkAllLocatorVisibility(locatorsPIP, expect);
...
logger.info("Add GP button clicked successfully");
 ...
 let locatorsGP = [
          ...
          addgp.txtbox_GPTitle,
          addgp.txtbox_GPInitials,
          addgp.txtbox_GPGivenName,
          addgp.txtbox_GPFamilyName,
          addgp.txtbox_GPCode,
          addgp.txtbox_GPPracticeCode,
          addgp.txtbox_GPGMCCode,
          addgp.btnShowGP,
         // addgp.dropdown_UnknownPostcode,
          addgp.txtbox_GPPhone,
          addgp.txtbox_GPFax,
          addgp.txtbox_GPWorkPhone,
          addgp.txtbox_GPMobile,
          addgp.txtbox_GPEmail,
          addgp.btnSaveGP,
          addgp.txtPostcodeSearch,
          //addgp.postcodeValue,
          addgp.txtbox_GPNumberandRoad,
          addgp.txtbox_District,
          addgp.txtbox_GPTown,
          addgp.txtbox_GPCounty,
          addgp.txtbox_GpAddressPostCode,
         // addgp.txtbox_GPFullName
         
         
        ];

        
        fileName = "LocatorJSON/PatientDomain/PatientGPPage.json";
        await checkAllLocatorVisibility(locatorsGP, expect);
