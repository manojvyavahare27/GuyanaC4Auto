class AddAddress
{
    constructor(page)
    {
        ...
        this.txtbox_Destrict_Search=page.getByTestId('districtSearch')
    ...
    async enterDestrictSearch()
    {
        await this.txtbox_Destrict_Search.fill('4 MILES, PORT KAITUMA')
        await this.page.getByRole('option', { name: '4 MILES, PORT KAITUMA' }).click()
    }
   ...
   async selectTempCountry()
   {
    ...
    async selectTempHealthRegion()
    {
        ...
        await this.page.getByRole('option', { name: 'Region 01' }).click()
    }
