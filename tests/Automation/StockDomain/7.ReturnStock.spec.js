...
test.describe("Database Comparison Add New Referral", () => {
    ...
    test("Add New Referral @Functional @ReferralDomain", async ({ page }) => {
        ...
        const itemName = jsonData.AddNewStock[0].stock_name;
       
        const batchnum =  jsonData.AddNewStock[0].stbat_batch_number;
       

        const batchNumber = page.locator(`//h1[normalize-space()='${itemName}']/ancestor::tr/following-sibling::tr[1]//a[contains(@data-testid,'${batchnum}')]`);
       // const batchnumbers=page.locator("xpath=//h1[normalize-space()='Alkof 10ml']/ancestor::tr/following-sibling::tr[1]//a[contains(@data-testid,'Batch')]")
 await page.pause()

       //await returnItemsPopup.assertTextMatches(page,batchNumber,itemName)
        await page.pause()
