...
import { checkAllLocatorVisibility } from "../../../UtilFiles/DynamicUtility";
...
test.describe("Medications Category", () => {
  test("Add Medications", async ({ page }) => {
    ...
    await patientsearch.selectBornDate(data.pat_dob);
      ...
      await patientsearch.uncheckIncludeServicePatientIfChecked();
      await patientsearch.clickOnSearchButton();
     ...
     // await page.pause()
      ...
      // Check if popup is displayed and close it if visible
      const cancelIcon = page.getByRole('button', { name: 'cancelIcon' });
      ...
      // Check visibility of medication extra details locators
      let medicationLocators = [
        MedicationsExtraDetails.dose,
        MedicationsExtraDetails.form,
        MedicationsExtraDetails.Route,
        MedicationsExtraDetails.duration,
        MedicationsExtraDetails.units,
        
        MedicationsExtraDetails.site,
        MedicationsExtraDetails.prescribeBy,
        MedicationsExtraDetails.startDate,
        MedicationsExtraDetails.reviewDate,
        MedicationsExtraDetails.stopDate,
        MedicationsExtraDetails.sideEffect,
        MedicationsExtraDetails.medicationStatus,
        MedicationsExtraDetails.indication,
        MedicationsExtraDetails.stopReason,
        MedicationsExtraDetails.PGDPSD,
        MedicationsExtraDetails.medicationGradeForAdministrator,
        MedicationsExtraDetails.maxReffills,
      
        MedicationsExtraDetails.unit,
        MedicationsExtraDetails.currentLocation,
        MedicationsExtraDetails.linkToDiagnosis,
        MedicationsExtraDetails.adherent,
        MedicationsExtraDetails.endoserment,
        MedicationsExtraDetails.forCondition,
        MedicationsExtraDetails.priceCheckQuantity,
       
       
        MedicationsExtraDetails.prescribeAndSupply,
        MedicationsExtraDetails.supply,
        MedicationsExtraDetails.suitableForDelivery,
        MedicationsExtraDetails.addToPrescription,
        MedicationsExtraDetails.setAsDefault,
        MedicationsExtraDetails.repeatable,
        MedicationsExtraDetails.addToFavourite,
        MedicationsExtraDetails.privateRecord,
        MedicationsExtraDetails.addToOrderSet
      ];
      await checkAllLocatorVisibility(medicationLocators, expect);
   
      await MedicationsExtraDetails.clickAllMedicationCategoryIconsAndClosePopup();
