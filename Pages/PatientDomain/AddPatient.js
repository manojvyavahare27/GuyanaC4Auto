class AddPatient
{
    constructor(page)
    {
        ...
        //this.dropdown_marrital_status=page.getByTestId('Marital Status').getByLabel('​', { exact: true })
         ...
         this.dropdown_gender=page.getByRole('combobox', { name: 'Gender' })
    ...
    async selectGender()
    {
        await this.dropdown_gender.click()
    ...
    async selectPrimaryDisability(disability)
    {
        await this.dropdown_primarydisablity.click();
        await this.page.getByRole('option', { name: disability }).click();
    }
