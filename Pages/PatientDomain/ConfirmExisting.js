...
class ConfirmExisting
{
    constructor(page)
    {
        ...
        //Next of Kin
        this.dropdown_NextofKinTitle=page.locator("xpath=//div[@data-testid='kinTitle']")
        ...
        this.dropdown_Relcationship=page.locator("xpath=//div[@data-testid='kinRelationship']")
