...
class ClinicalExtraDetails {
  ...
  this.linkToProcedure = page.locator("xpath=//input[@name='linkToProcedure']");
    ...
    //Medication
    this.dose = page.locator("xpath=//input[@data-testid='Dose']");
    ...
    this.site = page.locator("xpath=//div[@data-testid='CommonCellmaPopup']//input[@name='site']");
    ...
    this.medicationGradeForAdministrator = page.locator("xpath=//input[@name='userGradesThatCanAdministratorMedication']");
                                                               //input[@name='userGradesThatCanAdministratorMedication']
    ...
    this.MCnotes = page.locator("xpath=//textarea[@name='notes']")
...
async selectMachineName(mname)
{
 ...
 async EnterNotes(page,inte_notes,pacr_que_name)
  ...
  // Click all medication category icons and close popup after each click
  async clickAllMedicationCategoryIconsAndClosePopup() {
    const medicationCategoryButtons = [
      this.page.locator("xpath=//button[@aria-label='categoryMedicationDosing']"),
      
       this.page.locator("xpath=//button[@aria-label='categoryDoseCalculator']"),
       this.page.locator("xpath=//button[@aria-label='categoryUploadFile']"),
       this.page.locator("xpath=//button[@aria-label='categoryAddedDocuments']"),
       this.page.locator("xpath=//button[@aria-label='categoryCreateOnReferral']"),
       this.page.locator("xpath=//button[@aria-label='categoryAddAppointment']"),
       this.page.locator("xpath=//button[@aria-label='categoryAddToTask']"),
          this.page.locator("xpath=//button[@aria-label='categoryAddToWorklist']"),
             this.page.locator("xpath=//button[@aria-label='categoryAddPathway']"),
                this.page.locator("xpath=//button[@aria-label='categoryAnnotationTool']")
                  

      // etc.
    ];
    for (const button of medicationCategoryButtons) {
      await button.click();
      await this.page.waitForTimeout(500); // Wait for popup to open
      await this.page.getByRole('button', { name: 'cancelIcon' }).click();
    }
  }
