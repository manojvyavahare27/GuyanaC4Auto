class EditPatient
{
    constructor(page)
    {
        ...
        this.link_ViewPIP=page.getByRole('cell', { name: 'View' }).getByTestId('View')
       ...
       //this.linkView
        ...
        this.dropdown_Ethnicity=page.locator("xpath=//input[@name='patEthnicityText']")
        this.dropdown_Religion=page.locator("xpath=//input[@name='patReligion']")
        this.dropdown_SexualOrientation=page.locator("xpath=//input[@name='patSexualOrientationEliId']")
        this.dropdown_CurrentlyPregnant=page.getByTestId('Currently Pregnant').getByRole('button', { name: '​' })
        this.dropdown_PrimaryDisablity=page.getByTestId('Primary Disability').getByRole('button', { name: '​' })
        this.dropdown_Prisoner=page.locator("xpath=//input[@name='patPrisoner']")
